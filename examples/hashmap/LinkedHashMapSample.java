...
public class LinkedHashMapSample
{
	...
	// the primitive int value below. Java converts it into the Integer object for us.
	...
	// Print the dictionary -- note the order of items is is in the order we inserted them -- due to the linked list
