...
/**
 * Disjoint Sets implementation from CLRS, Chapter 19. Can perform m operations
 * on n elements in O(m lg*n) time, which is O(m) for all practical purposes.
 * 
 * Shows use of assertions for checking pre/post conditions. Run with java
 * -enableassertions to use assert statements
 * 
 * @author amit
 */
public class DisjointSets<T>
{
    ...
    /**
     * Constructor: creates an empty array of set elements.
     * 
     * @param n
     */
    ...
    /**
     * 
     * Getter for an element at a given index.
     * 
     * @param index
     * @return
     */
    public SetElement<T> getElement(int index) {
        return sets[index];
    }


    /**
     * Getter for the count of find operations.
     * 
     * @return
     */
