...
/**
 * A simple example of using generic code to write a generic insertion sort. Note that we restrict
 * the values of the generic parameter T to only comparable types by having T be a subclass of 
 * Comparable.
 * 
 * @author amit
 *
