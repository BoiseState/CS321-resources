...
public class FasterWidgetMaker extends Thread
{
	...
	public void make()
	{
		for (int i = startIndex + 1; i < count + startIndex + 1; i++) {
			...
			System.out
					.println("Widget# " + i + " ready on thread " + threadNum);
		}
	}
	 ...
	 */
	private static void createAndRunThreads(int n, int numThreads)
			throws InterruptedException
	{
		...
		robotFactory[numThreads - 1] = new FasterWidgetMaker(numThreads,
				(numThreads - 1) * count, count + n % numThreads);
	...
	/**
	 * Creates the threads and then divide the work of making widgets amongst
	 * the threads.
	 * 
	 * @param args
	 * @throws InterruptedException
	...
	public static void main(String[] args) throws InterruptedException
	{
		...
		if (args.length != 1 && args.length != 2) {
			System.out.println(
					"Usage: java WidgetMaker <number of widgets> [<numThreads>]");
		...
		System.out.println("WidgetMaker: made " + n + " widgets in "
