 ...
 *
 */
public class CircularQueueGenericTest
{
	/**
	 * Run a simple smoke test. Add 10 elements, check queue, then remove ten
	 * elements and check queue again.
	 */
	private static void smokeTest()
	{
		CircularQueueGeneric<Integer> queue = new CircularQueueGeneric<Integer>(Integer.class, 10);
		try {
	...
	private static void testUnderflow()
	{
		...
		try {
			...
			e.printStackTrace();
			System.out.println(
					"CircularQueueTest: caught underflow on an empty queue");
		}
	}
	...
	private static void testOverflow()
	{
		...
		try {
			...
			e.printStackTrace();
			System.out.println(
					"CircularQueueTest: caught overflow on a full queue");
		}
	}
	 ...
	 * 
	 * @param args
	 *                 no command line arguments used at present
	 */
	public static void main(String[] args)
	{
		System.out.println(
				"CircularQueueTest: a simple smoke test with 10 elements");
		smokeTest();
		System.out.println();
