...
/**
 * Mergesort class. Provides two versions of merge sort.
 * 
 * @author amit
 */
...
public class MergeSort
{
    ...
    /**
     * Sort the section of the array A[p..r] using mergesort. See Section 2.3 of the
     * CLRS book.
     */
    ...
    /**
     * Merge, using sentinels, two sorted sequences A[p..q] and A[q+1..r] and place
     * merged output back in array A. Uses extra space proportional to A[p..r]+2.
     */
    ...
    /**
     * Sort the section of the array A[p..r] using merge sort with sentinels.
     */
